...
namespace OculusSampleFramework {
    ...
    public class DistanceGrabber : OVRGrabber {
        ...
        void Update() {
            ...
            {
                HandedInputSelector gett = GameObject.Find("UIHelpers").GetComponent<HandedInputSelector>();
                if (this.gameObject.name == "DistanceGrabHandLeft")
                {
                    gett.SetActiveController(OVRInput.Controller.LTouch);
                }
                if (this.gameObject.name == "DistanceGrabHandRight")
                {
                    gett.SetActiveController(OVRInput.Controller.RTouch);
                }
            }
        }
